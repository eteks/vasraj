            ...
            <section class="maincontent" id="maincontent">
                ...
                <section class="container"  id="maincontentbelow">
                    <div class="row">
                        ...
                        <div class="divide5"></div>
                        <div class="span12"><ul class="newroomlist">
                                ...
                                <li><a href="javascript:void(0);" class="active"><img src='images/reports.png' style="width:28px;"/> Reports</a></li>


                                <li><a href="archives.php"><img src='images/archive.png' style="width:28px;"/> Archives</a></li>
                            </ul></div>
                        <div class="span12">
                            <h4 class="article-title" style="font-size:22px;">Reports</h4>
                        </div>
                    </div>
                    <div class="row">
                        <article>
                            <div class="span12">
                                <div class="rti-table" id="reports">
        ...
        <script type="text/javascript">
            ...
            function displayRecords(pageNum) {
                $.ajax({
                    type: "POST",
                    url: "mediacenter.php",
                    data: "media=reports&pageno=" + pageNum,
                    cache: false,
                    beforeSend: function() {
