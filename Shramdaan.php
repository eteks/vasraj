        ...
        <section class="boxed-wrapper page">
            ...
            <section class="maincontent" id="maincontent">
                ...
                <article class="fullwidth_img_container_small">
                    <img src="images/Shramdaan.jpg" alt="" style="width:100%">
                </article>
                ...
                <section class="container" id="maincontentbelow">
                    <div class="row">
                        <div class="divide10"></div>
                        <div class="span12">
                            <h3 class="article-title">Shramdaan</h3>
                        </div>
                        <div class="divide5"></div>
                    </div>
                    <div class="row">
                        <article>
                            <div class="span6 Shramdaan">
                                <form name="Shramdaan" id="Shramdaan" class="Shramdaan sky-form" action="#" method="post">
                                    <label>Name</label>
                                    <label class="input"><input type="text" name="name" id="name" required/></label>
                                    <div class="divide10"></div>
                                    <label>Gender</label>
                                    <label><input type="radio" name="gender" value="M"/> Male &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gender" value="F"/> Female &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gender" value="T"/> Transgender</label>
                                    <div class="divide10"></div>
                                    ...
                                    <div class="divide10"></div>
                                    <label>Address</label>
                                    <label class="input"><textarea name="address" id="address"></textarea></label>
                                    <div class="divide10"></div>
                                    <label>Type of Sharamdaan</label>
                                    <label class="input">
                                        <select name="typesofsharamdan" id="typesofsharamdan">
                                            <option value="SP">Swachh Puducherry</option>
                                            <option value="E">Education</option>
                                            <option value="IT">IT Support</option>
                                            <option value="MS">Media Support</option>
                                            <option value="AP">Awareness Programe</option>
                                        </select>
                                    </label>
                                    <div class="divide10"></div>
                                    <label>Description</label>
                                    <label class="input"><textarea name="description" id="description"></textarea></label>
                                    <div class="divide10"></div>
                                    ...
                                    <input type="submit" name="submit" value="Submit" id="submit" class="readmore"/>
                                    <div class="message"></div>
                                </form>
                            </div>
<div class="span6"><iframe width="100%" height="315" src="https://www.youtube.com/embed/OjrRSq8JUAE" frameborder="0" allowfullscreen></iframe></div>
...
jQuery(".reset").click(function(){
            ...
            jQuery("#Shramdaan").validate(
            {
                rules:
                    {
                        ...
                        typesofsharamdan: {required: true, },
                ...
                messages:
                    {
                        ...
                        typesofsharamdan:
                            {
                                required: 'Please select Type of Sharamdaan'
                            },
                        txtCaptcha:
                            {
                ...
                {
                    $.ajax({
                        url: 'shramdaanmail.php',
                        type: 'POST',
                        data: $('#Shramdaan').serialize(),
                        beforeSend: function() {
