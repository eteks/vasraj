                ...
                <section class="container"  id="maincontentbelow">
                    <div class="row">
                        ...
                        <div class="span12"><ul class="newroomlist events-list">
                                ...
                                <li><a href="past_events.php" class="active">Past Events</a></li>
                            </ul></div>
                        <div class="span12">
                            <h4 class="article-title" style="font-size:22px;">Past Events</h4>
                        </div>
                    </div>
                    <div class="row">
                        <article>
                            <?php
                            $stmt = $db->prepare("select eventdtls_pk, ed_eventtitle, ed_eventdate, (select eg_mediaurl from eventgallery_tbl where eg_eventdtls_fk = eventdtls_pk and eg_mediatype='I' order by eventgallery_pk desc limit 1), ed_eventdesc from eventdtls_tbl WHERE ed_eventstatus='P' AND ed_status='P' ORDER BY eventdtls_pk DESC");
                            $stmt->execute();
                            $stmt->store_result();
