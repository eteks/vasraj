                            ...
                            <div class="span6 share-your-ideas" >
                                <form name="shareideas" id="shareideas" class="shareideas sky-form" action="#" method="POST">
                                    ...
                                    <label class="input" style="display: inline-block; float:left;width:100%;">
                                        ...
                                        <div style="display: inline-block; float:right;width:50%;"><input type="radio" name="radGroup" value="G" class="radio" style="display:inline;" /> Small Group(Max 5)</div>
                                    </label>
                                    <div class="divide10"></div>
                                    ...
                                    <label class="input">
                                        <input type="radio" name="radID" class="radio" value="DL" style="display:inline;" /> Driving License 
