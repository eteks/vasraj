    ...
    <body class="boxedlayout">
            ...
            <section class="maincontent" id="maincontent">
                ...
                <section class="container"  id="maincontentbelow">
                    <div class="row">
                        <div class="divide10"></div>
                        <div class="span12">
                            <h3 class="article-title">Media Center</h3>
                        </div>
                        <div class="divide5"></div>
                        <div class="span12">
                            <ul class="newroomlist">
                                <li><a href="newsroom.php"><img src='images/news.png' style="width:28px;"/> News Stream</a></li>
                                <li><a href="press.php"><img src='images/press-releas.png' style="width:28px;"/> Press Release</a></li>
                                <li><a href="javascript:void(0);" class="active"><img src='images/meeting.png' style="width:32px;"/> Meeting Minutes</a></li>
                                <li><a href="speechs.php"><img src='images/speechs.png' style="width:28px;"/> Speeches</a></li>
                                <li><a href="presentations.php"><img src='images/presentations.png' style="width:28px;"/> Presentations</a></li>
                                <li><a href="reports.php"><img src='images/reports.png' style="width:28px;"/> Reports</a></li>
                                <li><a href="archives.php"><img src='images/archive.png' style="width:28px;"/> Archives</a></li>
                            </ul>
                        </div>
                        <div class="span12">
                            <h4 class="article-title" style="font-size:22px;">Meeting Minutes</h4>
                        </div>
                    </div>
                    <div class="row">
                        <article>
                            <div class="span12">
                                <div class="rti-table" id="meeting-minutes">
        ...
                });
                jQuery(".bw").click(function () {
                    ...
                    jQuery(".rti-table table tr:nth-child(odd)").css("background-color", "black");
