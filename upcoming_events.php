...
<html lang="en">
    ...
    <!-- ADD class="boxedlayout" IN CASE THE SITE SHOULD BE BOXED -->
        ...
        <section class="boxed-wrapper home">
            <header class="header">
            ...
            <section class="maincontent" id="maincontent">
                ...
                <article class="fullwidth_img_container_small">
                    <img src="images/event-banner.jpg" alt="" style="width:100%">
                </article>
                ...
                <section class="container"  id="maincontentbelow">
                    <div class="row">
                        <div class="divide10"></div>
                        <div class="span12">
                            <h3 class="article-title">Events</h3>
                        </div>
                        <div class="divide5"></div>
                        <div class="span12"><ul class="newroomlist events-list">
                                <li><a href="upcoming_events.php" class="active">Upcoming Events</a></li>
                                <li><a href="past_events.php">Past Events</a></li>
                            </ul></div>
                        <div class="span12">
                            <h4 class="article-title" style="font-size:22px;">Upcoming Events</h4>
                        </div>
                    </div>
                    <div class="row">
                        <article>
                            <?php
                            $stmt = $db->prepare("select eventdtls_pk, ed_eventtitle, ed_eventdate, (select eg_mediaurl from eventgallery_tbl where eg_eventdtls_fk = eventdtls_pk and eg_mediatype='I' order by eventgallery_pk desc limit 1), ed_eventdesc from eventdtls_tbl WHERE ed_eventstatus='U' AND ed_status='P' ORDER BY eventdtls_pk DESC");
                            $stmt->execute();
                            $stmt->store_result();
                                ...
                                while ($stmt->fetch()) {
                                    ...
                                    <div class="span12 newsroom">
                                        <a href="events_details.php?id=<?= base64_encode($id); ?>">
                                            <div class="span3 marginl0"><img src="./admin/events/<?= $EventImage; ?>" alt=""/></div>
                                            <div class="span9">
