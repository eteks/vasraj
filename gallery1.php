            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="btn-group pull-right m-t-15">
                                    <button class="btn btn-default waves-effect waves-light" id="txtcategory" data-type="text" data-pk="1" data-placement="left" data-placeholder="Required" data-title="Enter Category Name">Add New Category</button>
                                </div>
                        ...
                        <div class="row port">
                        <?php
                        $stmt = $db->prepare("select a.id, a.cat_name, count(b.id), b.image, b.image_name from category a left join gallery b on a.id=b.category_id group by a.cat_name ORDER BY id DESC");
                        $stmt->execute();
                        $stmt->store_result();
                                    ...
                                    <div class="col-sm-6 col-lg-2 col-md-4">
                                        <div class="product-list-box thumb">
                                            ...
                                            <div class="product-action">
                                                <a href="#" data-cat="<?= $cat_name; ?>" data-id="<?= $id; ?>" class="btn btn-success btn-sm edit-gallery" data-type="text" data-pk="<?= $id; ?>" data-placement="right" data-placeholder="Required" data-title="Enter Category Name"><i class="md md-mode-edit"></i></a>
                                                <a href="#" data-id="<?= $id; ?>" class="btn btn-danger btn-sm delete-gallery"><i class="md md-close"></i></a>
                                            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#txtcategory').editable({
                    ...
                    placement: 'left',
                    name: 'category',
                    url: 'includes/helper.php?action=category_add',
                ...
                $('a.edit-gallery').editable({
                    name: 'category',
                    url: 'includes/helper.php?action=category_update&pk='+$(this).attr('data-pk'),
                    success: function(response) {
                        $('#txtcategory').html('Add New Category');
                        var msg = (response == 1)? 'Successfully Saved' : 'Server Error. Try again...' ;
                        var alertType = (response == 1)? 'success' : 'warning' ;
