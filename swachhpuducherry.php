...
<html lang="en">
    <head>
        ...
        <title>LG Secretariat - Swachh Puducherry</title>
        ...
        <section class="boxed-wrapper page">
            ...
            <section class="maincontent" id="maincontent">
                ...
                <article class="fullwidth_img_container_small">
                    <img src="images/Swachh-banner.jpg" alt="" style="width:100%">
                </article>
                ...
                <section class="container"  id="maincontentbelow">
                    <div class="row">
                        <div class="divide10"></div>
                        <div class="span12">
                            <h3 class="article-title">Swachh Puducherry</h3>
                        </div>
                        <div class="divide10"></div>
                    </div>
                    <div class="row">
                        <article>
                            <?php
                            $stmt = $db->prepare("select eventdtls_pk, ed_eventtitle, ed_eventdate, (select concat(eg_mediaurl, '***', eg_mediatype) from eventgallery_tbl where eg_eventdtls_fk = eventdtls_pk order by eventgallery_pk desc limit 1), ed_eventdesc from eventdtls_tbl WHERE ed_eventstatus='S' AND ed_status='P' ORDER BY eventdtls_pk DESC");
                            $stmt->execute();
                            $stmt->store_result();
                            $stmt->bind_result($id, $EventTitle, $EventDate, $EventImage, $eventdesc);
                            if ($stmt->num_rows > 0) {
                                while ($stmt->fetch()) {
                                    $EventImage1 = explode('***', $EventImage);
                                    if($EventImage1[1] == 'V')
                                    {
					$eeventimg = explode('=', $EventImage1[0]);
                                        $e_mediaa = end($eeventimg);
                                        $EventImg = 'https://i1.ytimg.com/vi/'.$e_mediaa.'/0.jpg';
                                    } else {
                                        $EventImg = './admin/events/'.$EventImage1[0];
                                    }
                                    ?>
                                    <div class="span12 newsroom">
                                        <a href="events_details.php?id=<?= base64_encode($id); ?>">
                                            <div class="span3 marginl0"><img src="<?= $EventImg; ?>" alt=""/></div>
                                            <div class="span9">
                                                <h4 class="blue-text"><?= $EventTitle; ?></h4>
                                                <div class="divide5"></div>
                                                ...
                                                <?= $eventdesc; ?>
<div class="divide10"></div>
<a href="events_details.php?id=<?= base64_encode($id); ?>" class="btn readmore small-more">Read more</a>
        ...
        <script type='text/javascript'>
                                    jQuery(document).ready(function ()
                                    {
                                        jQuery("a#skip").click(function () {
                                            //alert();			
                                            jQuery('html, body').animate({scrollTop: jQuery('#maincontentbelow').offset().top - 30},
                                                    'slow');
                                        });
