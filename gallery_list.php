    ...
    if ($_FILES['file']['name'] != '') { //check if file field empty or not
        ...
        if(in_array(mime_content_type($_FILES['file']['tmp_name']), $mime_arr))
        {
            if(in_array($ext1, $ext))
            {
                ...
                $image_date = date('Y-m-d', strtotime($_POST['txtDate']));
...
<html>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            $stmt = $db->prepare("select cat_name from category where id=?");
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <a href="gallery.php" class="btn btn-default waves-effect waves-light" ><< Back</a>
                                </div>
                                        ...
                                        <div class="col-sm-6 col-lg-2 col-md-4">
                                            <div class="product-list-box thumb">
                                                ...
                                                <div class="product-action">
                                                    <a href="#" data-pk="<?= base64_encode($pk); ?>" class="btn btn-danger btn-sm delete-gallery"><i class="md md-close"></i></a>
                                                </div>
