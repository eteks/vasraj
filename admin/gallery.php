            ...
            <div class="content-page">
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="btn-group pull-right m-t-15">
                                    <button class="btn btn-default waves-effect waves-light" style="margin-left: 30px;" id="txtcategory" data-type="text" data-pk="1" data-placement="left" data-placeholder="Required" data-title="Enter Category Name">Add New Category</button>
                                </div>
                        ...
                        <?php
                        $stmt = $db->prepare("select a.id, a.cat_name, count(b.id), SUBSTRING_INDEX(group_concat(b.image order by b.image_date DESC SEPARATOR '**'),'**',-1), b.image_name from category a left join subcategory sub on a.id=sub.cat_id left join gallery b on sub.id=b.category_id group by a.id ORDER BY b.image_date DESC");
                        $stmt->execute();
                        $stmt->store_result();
                            ...
                            ?>
                                <div class="col-sm-6 col-lg-2 col-md-4">
                                    <div class="product-list-box thumb">
                                        ...
                                        <a href="gallerysub.php?id=<?= $id; ?>"><h5><?= $cat_name.' (Images - '.$cnt.')'; ?></h5></a>
                                    </div>
                                </div>
                        <?php } } ?>
                            </div>
