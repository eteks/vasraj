...
<html>
    <head>
        ...
        <title>Rajnivas - Upcoming Events</title>
                                        ...
                                        <tbody>
                                            ...
                                            if ($stmt->num_rows > 0) {
                                                while ($stmt->fetch()) {
                                                    ...
                                                    .'<a href="eventcomments.php?uid='.$id.'" target="_blank" class="on-default" title="View Comments"><i class="fa fa-commenting"></i></a>&nbsp;&nbsp;&nbsp;'
                    ...
                    <div class="modal-dialog"> 
                        <div class="modal-content">
                            <form action="#" data-parsley-validate novalidate id="form-upevents">
                                ...
                                <input type="hidden" name="eventType" value="U" />
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#btnaddnew').on('click', function(){
                    ...
                    $('input[name=pk]').val('');
                    $('input[name=eventType]').val('U');
                    $('div.modal-header h4.modal-title').html('Add New Upcoming Events');
                });
            });
