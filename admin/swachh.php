...
<html>
    <head>
        ...
        <title>Raj Nivas - Swachh Puducherry</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Swachh Puducherry</h4>
                                <ol class="breadcrumb">
                                    <li>
                                        <a href="dashboard.php">Dashboard</a>
                                    </li>
                                    <li>
                                        <a href="#">Swachh Puducherry</a>
                                    </li>
                                    <li class="active">
                                        View
                                    </li>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $db->prepare("select eventdtls_pk, ed_eventtitle, ed_eventdate, if(ed_status='P', 'Published', 'Draft'), count(eventgallery_pk), ed_createdon from eventdtls_tbl left join eventgallery_tbl on eg_eventdtls_fk = eventdtls_pk WHERE ed_eventstatus='S' group by eventdtls_pk");
                                            $stmt->execute();
                                            $stmt->store_result();
                                            $stmt->bind_result($id, $EventTitle, $EventDate, $Status, $mcnt, $createdon);
                                            if ($stmt->num_rows > 0) {
                                                while ($stmt->fetch()) {
                                                    $id1 = $id;
                                                    $id = base64_encode($id);
                    ...
                    <div class="modal-dialog"> 
                        <div class="modal-content">
                            <form action="#" data-parsley-validate novalidate id="form-upevents">
                                ...
                                <input type="hidden" name="eventType" value="S" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12"> 
                                            <div class="form-group"> 
                                                <label for="field-2" class="control-label">Campaign Title</label> 
                                                <input type="text" class="form-control" id="field-2" placeholder="Campaign Title" parsley-trigger="change" required name="txtTitle" />
                                            </div> 
                                        </div> 
                                    </div>
                                    <div class="row"> 
                                        <div class="col-md-12"> 
                                            <div class="form-group no-margin"> 
                                                <label for="field-7" class="control-label">Campaign Description</label> 
