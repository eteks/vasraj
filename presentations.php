                    ...
                    <div class="row">
                        ...
                        <div class="span12">
                            <ul class="newroomlist">
                                ...
                                <li><a href="javacsript:void(0);" class="active"><img src='images/presentations.png' style="width:32px;"/> Presentations</a></li>
                        ...
                        <div class="span12">
                            <h4 class="article-title" style="font-size:22px;">Presentations</h4>
                        </div>
                    </div>
                    <div class="row">
                        <article>
                            <div class="span12">
                                <div class="rti-table" id="presentation">
        ...
        <script type="text/javascript">
            ...
            function displayRecords(pageNum) {
                $.ajax({
                    type: "POST",
                    url: "mediacenter.php",
                    data: "media=presentation&pageno=" + pageNum,
                    cache: false,
                    beforeSend: function() {
