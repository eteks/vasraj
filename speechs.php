                ...
                <section class="container"  id="maincontentbelow">
                    <div class="row">
                        ...
                        <div class="span12"><ul class="newroomlist">
                                ...
                                <li><a href="javascript:void(0);" class="active"><img src='images/speechs.png' style="width:32px;"/> Speeches</a></li>
                        ...
                        <div class="span12">
                            <h4 class="article-title" style="font-size:22px;">Speeches</h4>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <article>
                            <div class="span12">
                                <div class="rti-table" id="speeches">
        ...
        <script type="text/javascript">
            ...
            function displayRecords(pageNum) {
                $.ajax({
                    type: "POST",
                    url: "mediacenter.php",
                    data: "media=speeches&pageno=" + pageNum,
                    cache: false,
                    beforeSend: function() {
