        ...
        <section class="boxed-wrapper page">
            ...
            <section class="maincontent" id="maincontent">
                ...
                <article class="fullwidth_img_container_small">
                    <img src="images/rajnivas.jpg" alt="" style="width:100%">
                </article>
                ...
                <section class="container" id="maincontentbelow">
                    <div class="row">
                        <div class="divide10"></div>
                        <div class="span12">
                            <h3 class="article-title">Feedback</h3>
                        </div>
                        <div class="divide5"></div>
                    </div>
                    <div class="row">
                        <article>
                            <div class="span6 share-your-ideas">
                                <form name="shareideas" id="shareideas" class="shareideas sky-form" action="#" method="POST">
                                    ...
                                    <label class="input"><textarea name="message" id="message"></textarea></label>
                                    <div class="divide10"></div>
                    ...
                    submitHandler: function (form)
                    {
                        $.ajax({
                            ...
                            success : function(data) {
                                if(data=='1')
                                {
                                    $('div.message').html('Your Feedback posted successfully!').css({'color':'#6fb679', 'display':'block'});
