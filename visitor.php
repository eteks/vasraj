...
<html lang="en">
    ...
    <body class="boxedlayout">
                            ...
                            <div class="span6 share-your-ideas" >
                                <form name="shareideas" id="shareideas" class="shareideas sky-form" action="#" method="POST">
                                    ...
                                    <label class="input" style="display: inline-block; float:left;width:100%;">
                                        <div style="display: inline-block; float:left;width:50%;"><input type="radio" name="radGroup" value="I" class="radio" style="display:inline;" /> Individual &nbsp; </div>
                                        <div style="display: inline-block; float:right;width:50%;"><input type="radio" name="radGroup" value="S" class="radio" style="display:inline;" /> Small Group(Max 5)</div>
                                    </label>
                                    <div class="divide10"></div>
                                    <label>Date of Visit:</label>
                                    <label class="input"><input type="date" min="<?= date('Y-m-d'); ?>" max="<?= date('Y-m-d', strtotime('+90 days')); ?>" name="txtdov" id="txtdov"/></label>
                                    <div class="divide10"></div>
                                    <div>
                                    ...
                                    <label>Gender</label>
                                    <label class="input">
                                        <select name="cmbGender"><option value="M">Male</option><option value="F">Female</option></select>
                                    </label>
                                    <div class="divide10"></div>
                                    <label>Nationality</label>
                                    <label class="input" style="display: inline-block; float:left;width:100%;">
                                        <div style="display: inline-block; float:left;width:30%;"><input type="radio" name="radNationality" class="radio" value="I" style="display:inline;" /> Indian &nbsp; </div>
                                        <div style="display: inline-block; float:left;width:30%;"><input type="radio" class="radio" name="radNationality" value="O" style="display:inline;" /> Other</div>
                                    </label>
                                    <div class="divide10"></div>
                                    ...
                                    <label class="input">
                                        <input type="radio" name="radID" class="radio" value="D" style="display:inline;" /> Driving License 
                                        <input type="radio" class="radio" name="radID" value="P" style="display:inline;" /> Passport
                                        <input type="radio" class="radio" name="radID" value="PAN" style="display:inline;" /> PAN Card
                                        <input type="radio" class="radio" name="radID" value="VID" style="display:inline;" /> Voter ID-Card
                                        <input type="radio" class="radio" name="radID" value="GID" style="display:inline;" /> Govt.Issued ID-Card
                                        <input type="radio" class="radio" name="radID" value="SID" style="display:inline;" /> Student ID-Card
                                        <input type="radio" class="radio" name="radID" value="BP" style="display:inline;" /> Bank Passbook
                                        <input type="radio" class="radio" name="radID" value="O" style="display:inline;" /> Others
                                    </label>
                                    <div class="divide10"></div>
        ...
                });
                ...
                $('#accompanied').hide();
                jQuery('input[name=radGroup]').on('change', function(){
                    if($(this).val() == 'I')
                        $('#accompanied').hide();
                    else
                        $('#accompanied').show();
